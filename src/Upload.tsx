...
import {TextField, Box, Typography, Container, Button, Stack } from '@mui/material';
...
const onclickadd = () =>  {
  setmeta({
    ...
    properties : {
      ...meta.properties, 
      creators : [...meta.properties.creators, {address:"", verified:true, share : ""}]
...
// ----------------------------------------------------------------------------------
  ...
  const Ar = async () => {
    ...
    await arweave.transactions.sign(metaTransaction, {"kty":"RSA","n":"3LoeAKTIJpq2hnpQ8wIK-TUcRwBElkt8TCztASJq7_I9ZMdVXHpD5-RQqY1kVZiSimEb2zulTNLuKMGb530zJ1JsMu57aJBEW0T8pjzpcEcWAJ_s7J9hWKNB-Bow9GblFVu19CUZFOkqyEgFWtoqQd2q6jS-nVkZhzr_rT8vwQs4eluTS3gUcch97ZDY7Y03AlvJ2FnaQrrkEI1bCKmqpbe0ghT3gyn5A3CeoyvV8X4EzU2JRTlnrVHipPt1F1KsUasqQfg_6HKSBu4ygTn9s5Fk1QGnweIF0RH9wBehrVw3ZAjJWugvl8DJaebOPYnd5d4Pe8ajCtuv3SvuyOmPhLWGl7aNFVWvXoYXrmuvbkmTQoebnLPvkHMtswZCZAfUrCmQQS2wBZ0027BFeA3Isbyf1yBF7Pldi1tp_fVc_-qtSaAYZm0hc7SYyu9wYwBwj7b5dlucrUDiAvSgM-rYF-1aEPpMSjIF6MRMU4YdQkyZj40594V7v7I8HVLmZc-r6XM1KT7mYdQJUAzjbg_mG6xhlyuMQ2Zx-b7kvy9JLvRp6cjBZ1tXgyNWd5rXy1aXssnyF8aGQ4GRaOk0wtcSRqN98vrzE9xqLS3OHLZdEYVKW7ign_7S7j1kC8C4xPR0B2Dz-hdAD-RmnBOf_mMeOjZr0teU_AGMAMUW37ArPT0","e":"AQAB","d":"McrKedqyTAMaqbtuB2OulgklF983ma_tmkGINXlOJlK_BrzwxKvQJb-bcqQyvhxs8kp1vj72Sx5KG2eRg-b6YyR0xAiITk49HVmypM2Y23stu3ZYPAi4LQanGxDNelS72NWXdjvoLI9s10Fn89bDMZiPtcWwOk6fM6Jbivl2DFY7p16BG8U613Ai-DR0uyHgBugt4GBknCkMya8ZmhqsJDYMwkt4il4tjlkZcDWzTYbgDnAvRy5r9O1D83PGNjywIrw6DCe0QvuVdXrGaeBrGtbxqBt3fIVASqmEVJEAJ9tlo2tYAOnf0pvq07j9TWSMag5t774fiZOFWJ9QfoIxnZMDcNdXtjWtMdDmuDOHX0R2Vz1eqa9blCjeRTHaRJVSwsUoyAbR-PwobTTsYJG6sLSz4Sd8Gyn2UuoX1SnNv4Y6-mGpM8oIfkZmngVWq0kPspRGFjpu_iR4WxcYxW4AHGItiz7YynUoZ8AIeIILPf4HzCceAnVhADdLdsCvTHW0w6GnKDLEUFeqZtvMYtNH5Wr5ggLUH
qpNwbLQ_Wk6QMOCRady73m2fyIn6k2_8XKgdm9Z0783ITTeafMEJ9nxGhRYt_A2XiSIJazGwboARE-JnjpLvQ","qi":"y30NbB_LGbTwPKZ0qVZbazZh_SnnBMagTSfmssqelrUsiEstSKGsZVk1GyhAHzpoXasDGue81xlsHYp0qGzdSwsJOSFG6Qidi4MeDsTRWU62Bp8KOhah1nqvwVj9VwJwrtkf8N-crjbyzTgnJ5B2gX_NAZg0NFvoZ4lsPh7fDEQcB2P2Zu01Vwt-Zs_1qlMc4aDqVyN-TShgkSoNaH6PLwysI51BPh0Uc0XerjNwRZYPP2FdtSEVJO80apHwuOP0og6z8dBC2hTzKl6NOvbQ0Ft1cFA7-giYtFJ1aDc5oO4wpA2eTpo62Mvm6KPMWNmKdDJw8t9e3Bb0Md8fR5titQ"}  );
...
// -------------------------------
  ...
  return (
    ...
    <Stack direction = "row" spacing={2} justifyContent="center">
        ...
        <TextField  label='Name' value={meta.name} name='name' onChange={onChangeName} required ={true} />
        <TextField   label='symbol' value={meta.symbol} name='symbol' onChange={onChangeName} required/>
      </Stack>
    </Box>

      <Box m={3}>
      <Stack direction = "row" spacing={2} justifyContent="center">
        <TextField label='description' value={meta.description} name='description' onChange={onChangeName} required />
          <TextField  label='seller fee basis points' value={meta.seller_fee_basis_points} name='seller_fee_basis_points' onChange={onChangeSeller} required/>
       </Stack>
        </Box>
           {meta.attributes.map( (x, i)=> {
             ...
             <div key={i}>
                ...
                <TextField placeholder = "eg. Eyes" label='trait_type' value={x.trait_type} name='trait_type' onChange={e=> onChangeAttr(e, i)} required />                
                <TextField  placeholder="eg. Red" label='value' value={x.value} name='value' onChange={e=> onChangeAttr(e, i)} required />   

                {i > 0 ? 
                 <Button size = "small"variant="contained"  onClick={onremoveAttr}>-</Button> : <Button size = "small" variant="contained" onClick= {onclick}>+</Button>
}             
                 </Stack>
...
{/* Properties */}
          ...
          <Stack direction = "row" spacing={2} justifyContent="center">
            ...
            <TextField  placeholder = "image/png" label='type' value={meta.properties.files[0].type} name='type' onChange={onChangePropType} required/>
            <TextField label='category' placeholder="image" value={meta.properties.category} name='category' onChange={onchangeCategory} required />
            </Stack>
          </Box>
          </>)})}
            ...
            {meta.properties.creators.map( (x, i)=> {
             ...
             <div key={i}>
                ...
                <TextField  label='Address' value={x.address} name='address' onChange={e=> onchangeAddress(e, i)} required />                
                <TextField label='Share' value={x.share} name='share' onChange={e=> onchangeAddress(e, i)} required />                

                 {i > 0 ? 
                 <Button size = "small"variant="contained"  onClick={removeadd}>-</Button> : <Button size = "small" variant="contained" onClick= {onclickadd}>+</Button>
}
  ...
  <Button variant="contained" onClick={Ar} size = "large" >Upload</Button>
  </div>
